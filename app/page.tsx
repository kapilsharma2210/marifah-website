...
const pageContent: Record<string, { title: string; sections: { heading: string; body: string }[] }> = {
  about: {
    ...
    sections: [
      ...
      { heading: "Why Businesses Trust Us", body: "CHECKLIST:Experienced & certified tax professionals|100% FTA-compliant processes|Transparent pricing — no hidden charges|Fast turnaround — registrations done in days|Dedicated support — we answer your calls and emails|Serving 5000+ businesses across UAE" },
            ...
            <img
              src={
                svc.title === "Corporate Tax"
                  ? "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=1600&q=90"
                  : svc.title === "UAE VAT"
